...
└── src/
    ...
    │   ├── client.ts         # fetch wrapper: base URL, X-Cart-Id (+ auth in Phase 5), ApiError, NetworkError
    │   ├── session.ts        # Zustand-persisted session: cartId (auth token in Phase 5); in the API layer
